    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      flake = {
        overlays.default = final: prev: {
          deploy = self.packages.${final.stdenv.system}.deploy-rs;
      ...
      perSystem =
...

        {
          ...
          packages.deploy-rs = self.packages.${system}.default;
          ...
          // (lib.optionalAttrs (lib.elem system [ "x86_64-linux" ]) import ./nix/tests {
            inherit inputs pkgs;
          });
        };
    };
